...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/dotnet-basic-rpzycfha:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/dotnet-basic-rpzycfha-gitops
